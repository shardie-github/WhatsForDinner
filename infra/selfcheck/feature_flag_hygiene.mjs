...
const AUDIT = process.env.AUDIT_DIR || 'docs/audit';
...
fs.writeFileSync(
  path.join(AUDIT, 'feature_flag_hygiene.txt'),
  hasKill ? 'OK: kill-switch patterns found' : 'WARN: no kill-switch semantics detected'
);
