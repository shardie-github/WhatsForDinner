...
import { users, mealPlans, healthMetrics, dsarRequests, dsarArtifacts, recipes, } from '../db/schema.js';
 ...
 */
export async function generateDSARExport(requestId) {
    ...
    let userId = request.user_id || null;
