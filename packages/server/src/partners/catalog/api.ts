 ...
 */
export async function fetchAPIFeed(
 ...
 */
function transformDefault(item: unknown): ParsedCatalogItem | null {
  ...
  // Parse availability
  let availability: 'in_stock' | 'out_of_stock' | 'preorder' | 'discontinued' = 'in_stock';
  if (obj.availability) {
