-- ============================================================================
-- FILTERED CONSOLIDATED SUPABASE MIGRATION FILE
-- ============================================================================
-- This file contains ONLY migrations with:
--   - New tables not in master schema
--   - ALTER TABLE statements (modifications)
--   - Functions, policies, triggers, indexes, types
--
-- Excluded migrations that only create tables already in master schema
-- ============================================================================


-- ============================================================================
-- FROM: 013_ai_system_schema.sql
-- REASONS: ALTER TABLE, functions, policies, indexes
-- ============================================================================
...
-- REASONS: 17 new tables, ALTER TABLE, functions, policies, triggers, indexes
-- ============================================================================
...
-- REASONS: 1 new tables, ALTER TABLE, functions, policies, triggers
-- ============================================================================
...
-- REASONS: 1 new tables, ALTER TABLE, functions, policies, triggers, indexes
-- ============================================================================
...
-- REASONS: ALTER TABLE, functions, policies, triggers, indexes
-- ============================================================================
...
-- REASONS: functions, triggers, indexes
-- ============================================================================
...
-- REASONS: ALTER TABLE, functions, policies, triggers, indexes, types/enums
-- ============================================================================
...
-- REASONS: ALTER TABLE, functions, policies
-- ============================================================================
...
-- REASONS: 13 new tables, ALTER TABLE, functions, policies, triggers, indexes, types/enums
-- ============================================================================
...
-- REASONS: 9 new tables, ALTER TABLE, policies, triggers, indexes, types/enums
-- ============================================================================
...
-- REASONS: 6 new tables, ALTER TABLE, policies, indexes, types/enums
-- ============================================================================
...
-- REASONS: 12 new tables, ALTER TABLE, functions, policies, triggers, indexes, types/enums
-- ============================================================================
...
-- REASONS: 10 new tables, ALTER TABLE, policies, indexes, types/enums
-- ============================================================================
...
-- REASONS: 9 new tables, ALTER TABLE, functions, policies, triggers, indexes
-- ============================================================================
...
-- REASONS: 6 new tables, ALTER TABLE, functions, policies, triggers, indexes, types/enums
-- ============================================================================
...
-- REASONS: 1 new tables, ALTER TABLE, functions, policies, indexes
-- ============================================================================
...
-- REASONS: 1 new tables, ALTER TABLE, policies, indexes
-- ============================================================================
...
-- ============================================================================
-- FROM: 044_gamify.sql
-- REASONS: 1 new tables, ALTER TABLE, policies
-- ============================================================================
...
-- REASONS: 11 new tables, ALTER TABLE, functions, policies, triggers, indexes
-- ============================================================================
...
-- REASONS: 2 new tables, ALTER TABLE, policies, triggers, indexes
-- ============================================================================
...
-- REASONS: 3 new tables, ALTER TABLE, functions, policies, triggers, indexes
-- ============================================================================
...
-- REASONS: 6 new tables, ALTER TABLE, functions, policies, triggers, indexes
-- ============================================================================
...
-- REASONS: 8 new tables, ALTER TABLE, functions, policies, triggers, indexes
-- ============================================================================
...
-- REASONS: 2 new tables, ALTER TABLE, functions, policies, triggers, indexes
-- ============================================================================
