...
serve(async req => {
  ...
  try {
    ...
    if (path.startsWith('/pantry')) {
      return await handlePantryRoutes(
        supabaseClient,
        user.id,
        method,
        path,
      ...
      return await handleRecipeRoutes(
        supabaseClient,
        user.id,
        method,
        path,
      ...
      return await handleFavoriteRoutes(
        supabaseClient,
        user.id,
        method,
        path,
...
async function handlePantryRoutes(
  supabaseClient: any,
  userId: string,
  method: string,
  path: string,
...
async function handleFavoriteRoutes(
  supabaseClient: any,
  userId: string,
  method: string,
  path: string,
