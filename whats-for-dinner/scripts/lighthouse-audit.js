...
class LighthouseAuditor {
  ...
  async auditPerformance() {
    ...
    try {
      ...
      if (fs.existsSync('./lighthouse-performance.json')) {
        const results = JSON.parse(fs.readFileSync('./lighthouse-performance.json', 'utf8'));
        const performance = results.categories.performance;
        
        this.auditResults.categories.performance.score = Math.round(performance.score * 100);
  ...
  async auditAccessibility() {
    ...
    try {
      ...
      if (fs.existsSync('./lighthouse-accessibility.json')) {
        const results = JSON.parse(fs.readFileSync('./lighthouse-accessibility.json', 'utf8'));
        const accessibility = results.categories.accessibility;
        
        this.auditResults.categories.accessibility.score = Math.round(accessibility.score * 100);
  ...
  async auditBestPractices() {
    ...
    try {
      ...
      if (fs.existsSync('./lighthouse-best-practices.json')) {
        const results = JSON.parse(fs.readFileSync('./lighthouse-best-practices.json', 'utf8'));
        const bestPractices = results.categories['best-practices'];
        
        this.auditResults.categories.bestPractices.score = Math.round(bestPractices.score * 100);
  ...
  async auditSEO() {
    ...
    try {
      ...
      if (fs.existsSync('./lighthouse-seo.json')) {
        const results = JSON.parse(fs.readFileSync('./lighthouse-seo.json', 'utf8'));
  ...
  async auditPWA() {
    ...
    try {
      ...
      if (fs.existsSync('./lighthouse-pwa.json')) {
        const results = JSON.parse(fs.readFileSync('./lighthouse-pwa.json', 'utf8'));
  ...
  generateReport() {
    ...
    fs.writeFileSync('LIGHTHOUSE_AUDIT_REPORT.json', JSON.stringify(report, null, 2));
...
${report.categories.performance.issues.map(issue => `### ${issue.title}
...
${report.categories.accessibility.issues.map(issue => `### ${issue.title}
- **Description:** ${issue.description}
- **Score:** ${Math.round(issue.score * 100)}/100
- **Impact:** ${issue.impact}
`).join('\n')}
...
${report.categories.bestPractices.issues.map(issue => `### ${issue.title}
- **Description:** ${issue.description}
- **Score:** ${Math.round(issue.score * 100)}/100
- **Impact:** ${issue.impact}
`).join('\n')}
...
${report.categories.seo.issues.map(issue => `### ${issue.title}
- **Description:** ${issue.description}
- **Score:** ${Math.round(issue.score * 100)}/100
- **Impact:** ${issue.impact}
`).join('\n')}
...
${report.categories.pwa.issues.map(issue => `### ${issue.title}
- **Description:** ${issue.description}
- **Score:** ${Math.round(issue.score * 100)}/100
- **Impact:** ${issue.impact}
`).join('\n')}
...
${report.recommendations.map(rec => `### ${rec.title}
