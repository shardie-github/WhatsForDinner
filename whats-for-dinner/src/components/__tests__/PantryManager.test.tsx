...
describe('PantryManager', () => {
  ...
  it('renders add form and pantry items', () => {
    ...
    expect(screen.getByPlaceholderText('e.g., tomatoes, chicken breast...')).toBeInTheDocument()
  ...
  it('calls onAdd when form is submitted with valid data', async () => {
    ...
    const ingredientInput = screen.getByPlaceholderText('e.g., tomatoes, chicken breast...')
  ...
  it('shows empty state when no items', () => {
    ...
    expect(screen.getByText('No items in your pantry yet. Add some ingredients to get started!')).toBeInTheDocument()
  })
