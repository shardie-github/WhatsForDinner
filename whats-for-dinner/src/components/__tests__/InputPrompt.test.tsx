...
describe('InputPrompt', () => {
  ...
  it('renders input fields and buttons', () => {
    ...
    expect(screen.getByPlaceholderText('e.g., vegetarian, gluten-free, low-carb...')).toBeInTheDocument()
  ...
  it('calls onGenerate with correct parameters when form is submitted', async () => {
    ...
    const input = screen.getByPlaceholderText('Add an ingredient...')
    const preferencesInput = screen.getByPlaceholderText('e.g., vegetarian, gluten-free, low-carb...')
  ...
  it('disables submit button when loading', () => {
    ...
    const submitButton = screen.getByRole('button', { name: /generating recipes/i })
  ...
  it('does not show pantry section when no pantry items', () => {
    ...
    expect(screen.queryByText('Or add from your pantry:')).not.toBeInTheDocument()
  })
})